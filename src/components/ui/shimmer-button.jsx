...
const ShimmerButton = React.forwardRef((
  ...
  return (
    (<button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 p-1 text-violet-500 [background:var(--bg)] [border-radius:var(--radius)] w-24",
